...
- PublicAML (бесплатный KYT API без ключей, `checkPublicAML`): скор 0–100, сущность, санкции, direct/indirect экспозиция и propagated sources с хопами. В скоринге: санкции +60, скор ≥70 → +40, ≥40 → +15, плюс консенсус-якорь (итог не ниже их скора). Fail-soft слой молодого сервиса — никогда не блокирует остальные сигналы.
